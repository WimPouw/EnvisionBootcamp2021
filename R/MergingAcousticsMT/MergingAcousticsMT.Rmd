...
* location Rmarkdown: https://github.com/WimPouw/EnvisionBootcamp2021/tree/main/R/MergingAcousticsMT.Rmd

* citation: Pouw, W. (`r Sys.Date()`). *Selecting, smoothing, and deriving measures from motion tracking, and merging with acoustics and annotations*. [the day you viewed the site]. Retrieved from: https://github.com/WimPouw/EnvisionBootcamp2021/tree/main/R/ExtractAmplitudeEnvelope
